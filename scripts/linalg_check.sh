...
for prog in test/linalg_dump.mere test/linalg_props.mere test/raster_dump.mere test/raster_props.mere test/shade_props.mere test/srgb_dump.mere test/tex_dump.mere; do
